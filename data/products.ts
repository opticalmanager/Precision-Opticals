...
export const PRODUCTS: Product[] = [
  {
    id: 'figma-cartier-blue-rimless',
    brand: 'CARTIER',
    name: '06430 003 53 Burgundy Acetate Eyeglasses',
    subtitle: '06430 003 53 Burgundy Acetate Eyeglasses',
    price: 87125,
  ...
  },
  {
    ...
    brand: '',
    name: 'Blue Rectangle Eyeglasses for Men and Women',
    subtitle: 'Blue Rectangle Eyeglasses for Men and Women',
    price: 87125,
    originalPrice: 102500,
    category: 'sunglasses',
    gender: 'unisex',
    ...
    colorHex: '#A3684B',
    lensProperties: ['polarized', 'gradient', 'uv-protection'],
    isNewArrival: true,
    isBestSeller: true,
    rating: 5.0,
